...
class SO3_testing(unittest.TestCase):
    def testConstructor(self):
        for i in range(100):
            ...
            # This test passes. Use an extrinsic rotation because internally scipy does active rotations. Include proof elsewhere
            R_true = Rotation.from_euler('zyx', [angles[2], angles[1], angles[0]]).as_dcm().T
    ...
    def testFromAxisEuler(self):
        for i in range(100):
            ...
            R_true = Rotation.from_rotvec(vec*theta).as_dcm().T
